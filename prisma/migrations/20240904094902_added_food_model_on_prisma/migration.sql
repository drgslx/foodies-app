...
CREATE TABLE `User` (
    ...
    `role` ENUM('USER', 'INSTRUCTOR', 'COOK', 'ADMIN') NOT NULL DEFAULT 'USER',
...
CREATE TABLE `Food` (
    ...
    INDEX `Food_userId_catId_idx`(`userId`, `catId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Asset` (
    ...
    INDEX `Asset_courseId_foodId_idx`(`courseId`, `foodId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Enrolment` (
    ...
    INDEX `Enrolment_courseId_userId_foodId_idx`(`courseId`, `userId`, `foodId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
