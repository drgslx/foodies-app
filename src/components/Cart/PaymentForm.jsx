...
const PaymentForm = () => {
	...
	return (
		<form onSubmit={onSubmit} className="">
			...
			<div>
				<button
					className={`bg-[#262626] text-[#fff] text-[15px] text-center font-semibold block mt-[30px] py-[20px] px-[20px] leading-none border border-[#262626] transition duration-500 ease-in-out hover:bg-[#000] hover:border-[#000] hover:text-[#fff] ${
