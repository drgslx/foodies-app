...
const Services = () => {
	return (
		<>
			<div className="bg-[#F0F0F0] py-[50px] md:py-[80px] lg:py-[140px]">
						...
						<SwiperSlide>
							<div className="border border-[#051F0D] p-[35px] hover:bg-white hover:border-[#fff] transition delay-100 duration-300 ease-in-out hover:-top-[10px]">
								...
								<Link
									...
									className="text-black text-[14px] font-medium inline-block py-[15px] sm:py-[17px] px-[21px] sm:px-[30px] leading-none border border-[#23274A] transition duration-500 ease-in-out hover:bg-[#262626] hover:border-[#262626] hover:text-[#fff]"
								>
									More Details{" "}
