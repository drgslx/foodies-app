...
const FeedbackSlider = ({ testimonials = [] }) => {
	...
	return (
		<>
			<div className="bg-[#F0F0F0] py-[50px] md:py-[60px] lg:py-[140px] overflow-hidden">
					...
					>
						{testimonials.map((testimonial, index) => (
							<SwiperSlide key={index}>
								<div className="bg-[#F0F0F0] group border border-[#051F0D] p-[20px] md:p-[30px] lg:p-[50px] transition delay-100 duration-300 ease-in-out hover:bg-[#262626] hover:border-[#262626]">
