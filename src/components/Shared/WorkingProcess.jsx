					...
					<div className="relative space-y-[30px] lg:space-y-[50px]">
						...
						>
							<div className="grid items-center gap-[30px] lg:gap-[0] grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
								...
								<div className="text-[#F0F0F078] space-y-[15px] lg:pl-[30px] rtl:lg:pl-0 rtl:lg:pr-[30px] max-w-[496px]">
									<h3 className="text-[#F0F0F0] text-[22px] md:text-[25px] lg:text-[30px] leading-[1.1]">
										<span className="text-[#F0F0F078]">
											01.
										</span>{" "}
						...
						>
							<div className="grid items-center gap-[30px] lg:gap-[0] grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
								<div className="text-[#F0F0F078] space-y-[15px] xl:pl-[150px] rtl:xl:pl-0 rtl:xl:pr-[150px] max-w-[610px]">
									<h3 className="text-[#F0F0F0] text-[22px] md:text-[25px] lg:text-[30px] leading-[1.1]">
										<span className="text-[#F0F0F078]">
											02.
										</span>{" "}
