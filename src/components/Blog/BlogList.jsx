							...
							<div>
								...
								<ul className="sm:flex items-center space-y-[5px] sm:space-y-[0] sm:space-x-[20px] rtl:space-x-reverse">
									<li className="text-[13px] sm:text-[16px] flex items-center">
										<i className="ri-user-line text-[#262626] text-[17px] mr-2 rtl:mr-0 rtl:ml-2"></i>{" "}
										<Link
											href="#"
									...
									<li className="text-[13px] sm:text-[16px] flex items-center">
										<i className="ri-calendar-2-line text-[#262626] text-[17px] mr-2 rtl:mr-0 rtl:ml-2"></i>{" "}
										23 December 2023
									</li>
									<li className="text-[13px] sm:text-[16px] flex items-center">
										<i className="ri-time-line text-[#262626] text-[17px] mr-2 rtl:mr-0 rtl:ml-2"></i>{" "}
										03 Min Read
									</li>
								</ul>
							</div>
							...
							<nav aria-label="Page navigation example">
								<ul className="space-x-[5px] rtl:space-x-reverse">
									<li className="inline-block">
										<a
											href="#"
											className="flex items-center justify-center text-[14px] md:text-[16px] border border-[#051F0D] h-[36px] w-[40px] md:w-[55px] leading-tight rounded-[30px] font-semibold text-[##051F0D] hover:bg-[#262626] hover:border-[#262626] hover:text-[#fff]"
										>
