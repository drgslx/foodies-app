									...
									{currentUser.profile.linkedin && (
										<li className="inline-block">
											<a
												...
												target="_black"
												className="bg-[#fff] border border-[#FCA120] text-black w-[40px] h-[40px] leading-[36px] inline-block rounded-full text-center transition duration-500 ease-in-out hover:bg-[#262626] hover:border-[#262626] hover:text-white"
											>
