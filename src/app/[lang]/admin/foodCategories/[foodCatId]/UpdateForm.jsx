...
const UpdateForm = ({ foodCategory }) => {
	...
	useEffect(() => {
		setValue("name", foodCategory.name);
	}, [foodCategory]);

	const onUpdate = async (data) => {
		try {
			const url = `/api/admin/foodCategories/${foodCategory.id}`;
			...
			<div>
				<button
					...
					className="
                                ...
                                "
				>
					{isSubmitting ? "Please wait..." : "Update foodCategory"}
				</button>
			</div>
		</form>
	);
